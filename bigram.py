...
# Super simple BigramLanguageModel
class BigramLanguageModel(nn.Module):
    ...
    def __init__ (self):
        ...
        self.sa_heads = MultiHeadAttention(4, n_embd//4) # 4heads of 8-dimensional self attention
    ...
    def forward(self, idx, targets=None):
        ...
        x = self.sa_heads(x)
        logits = self.lm_head(tkn_emb) # (B,T, vocab_size)
        if targets is None:
            loss = None
        else:
            B,T,C = logits.shape
